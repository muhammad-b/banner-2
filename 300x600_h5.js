...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/HG_300x600.png", id:"HG_300x600"}
	]
};
...
(lib.HG_300x600 = function() {
	this.initialize(img.HG_300x600);
}).prototype = p = new cjs.Bitmap();
...
// stage content:
(lib._300x600_h5 = function(mode,startPosition,loop) {
	...
	// HG
	this.instance_1 = new lib.HG_300x600();
